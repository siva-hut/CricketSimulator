...
public class GetGameDetailResponse {
    ...
    public static GetGameDetailResponse getGameDetailResponse(GameDao gameDao, TeamStatsDao team1, TeamStatsDao team2){
        return GetGameDetailResponse.builder().gameId(gameDao.getId())
                .status("success")
